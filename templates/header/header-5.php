...
?>
    <nav class="giorgio-header navbar no-margin-bottom alt-font without-button header-white bg-white header-vertical-center <?php echo esc_attr($brando_header_text_color);?><?php echo esc_attr( $brando_enable_non_sticky );?>"<?php echo esc_html( $brando_header_top_offset ) ?>>
